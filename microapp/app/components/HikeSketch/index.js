  ...
  render() {
    return (
      <View style={this.props.containerStyle}>
        ...
        <View style={{flex:1, backgroundColor:'transparent',flexDirection: 'row' ,justifyContent:'flex-start',marginLeft:12}}>
         <View style={{ width:48,height:'100%',borderRightWidth:1,borderColor:'#898989',backgroundColor:'#2b2b2b' }}>
          <FlatList
        ...
        />
        <View style={{width:48,height:'100%',borderLeftWidth:1,borderColor:'#898989',backgroundColor:'#2b2b2b' }}>
          <View style={{ flexDirection: 'column',position:'absolute',right:0, top:140 }}>
