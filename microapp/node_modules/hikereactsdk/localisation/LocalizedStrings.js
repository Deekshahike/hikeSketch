...
var localization = NativeModules.HikeUtilsModule;
if (!localization) {
...
if(!localization.device_locale) {
    interfaceLanguage = "en";
} else if(!localization.isTotal) {
  if(localization.locale == "") {
    interfaceLanguage = localization.device_locale.replace(/_/g, '-');
  } else {
    interfaceLanguage = localization.locale.replace(/_/g, '-');
  }
} else {
    interfaceLanguage = localization.device_locale.replace(/_/g, '-');
}
