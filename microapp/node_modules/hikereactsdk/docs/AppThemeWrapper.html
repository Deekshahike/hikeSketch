...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AppThemeWrapper</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AppThemeWrapper</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AppThemeWrapper<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">App Theme Wrapper UI component, use this as a parent to any view where you want to show App Theme background image and rounded corners for chilren</div>
...
<article>
    ...
    <h4 class="name" id="AppThemeWrapper"><span class="type-signature"></span>new AppThemeWrapper<span class="signature">()</span><span class="type-signature"></span></h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">padding from top</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">padding from bottom</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_AppThemeWrapper.js.html">components/AppThemeWrapper.js</a>, <a href="components_AppThemeWrapper.js.html#line15">line 15</a>
    </li></ul></dd>
