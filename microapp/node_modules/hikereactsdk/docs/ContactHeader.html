...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ContactHeader</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ContactHeader</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ContactHeader<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">contact header accepts following props</div>
...
<article>
    ...
    <h4 class="name" id="ContactHeader"><span class="type-signature"></span>new ContactHeader<span class="signature">()</span><span class="type-signature"></span></h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">string to show the text on header</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">callback on the press of back icon</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>searchEnable</code></td>
            ...
            <td class="description last">boolean to show the search icon and enable search functioning</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>SearchFilterFunction</code></td>
            ...
            <td class="description last">callback to search or do something on writing text in textInput</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_contactPicker_ContactHeader.js.html">components/contactPicker/ContactHeader.js</a>, <a href="components_contactPicker_ContactHeader.js.html#line30">line 30</a>
    </li></ul></dd>
