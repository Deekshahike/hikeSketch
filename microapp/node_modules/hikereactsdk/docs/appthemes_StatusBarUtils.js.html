...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: appthemes/StatusBarUtils.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: appthemes/StatusBarUtils.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { Platform, StatusBar } from 'react-native';
...
export default StatusBarUtils;</code></pre>
        </article>
    </section>
