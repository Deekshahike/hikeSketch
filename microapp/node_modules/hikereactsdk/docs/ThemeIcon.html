...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ThemeIcon</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ThemeIcon</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ThemeIcon<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Theme icon component which accepts props</div>
...
<article>
    ...
    <h4 class="name" id="ThemeIcon"><span class="type-signature"></span>new ThemeIcon<span class="signature">()</span><span class="type-signature"></span></h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>iconProfile</code></td>
            ...
            <td class="description last">icon profile which will be applied at runtime</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">whether this icon is in selected state or not</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">if icon profile is not defined then component uses this field to color the icon. Default is main color</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">image source</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">style is applied on image</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">callback when icon is pressed</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="appthemes_components_ThemeIcon.js.html">appthemes/components/ThemeIcon.js</a>, <a href="appthemes_components_ThemeIcon.js.html#line21">line 21</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="appthemes_components_ThemeIcon.js.html">appthemes/components/ThemeIcon.js</a>, <a href="appthemes_components_ThemeIcon.js.html#line30">line 30</a>
    </li></ul></dd>
