...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: HalfScreenError</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: HalfScreenError</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>HalfScreenError<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Half Screen error UI component which shows error ui and try again button</div>
...
<article>
    ...
    <h4 class="name" id="HalfScreenError"><span class="type-signature"></span>new HalfScreenError<span class="signature">()</span><span class="type-signature"></span></h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>tryAgainClicked</code></td>
            ...
            <td class="description last">callback method invoked when try again button is clicked</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_HalfScreenError.js.html">components/HalfScreenError.js</a>, <a href="components_HalfScreenError.js.html#line13">line 13</a>
    </li></ul></dd>
...
<div class="description">
    Renders the half screen error ui component
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_HalfScreenError.js.html">components/HalfScreenError.js</a>, <a href="components_HalfScreenError.js.html#line18">line 18</a>
    </li></ul></dd>
