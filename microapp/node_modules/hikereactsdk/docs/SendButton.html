...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SendButton</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SendButton</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SendButton<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">sendButton accepts following props</div>
...
<article>
    ...
    <h4 class="name" id="SendButton"><span class="type-signature"></span>new SendButton<span class="signature">()</span><span class="type-signature"></span></h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>sendButtonEnable</code></td>
            ...
            <td class="description last">boolean for enabling sendButton</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>onSendPress</code></td>
            ...
            <td class="description last">callback on press of send button</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_contactPicker_SendButton.js.html">components/contactPicker/SendButton.js</a>, <a href="components_contactPicker_SendButton.js.html#line15">line 15</a>
    </li></ul></dd>
