...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Avatar</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Avatar</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Avatar<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Generic avatar component to show rounded avatar</div>
...
<article>
    ...
    <h4 class="name" id="Avatar"><span class="type-signature"></span>new Avatar<span class="signature">()</span><span class="type-signature"></span></h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">container size of avatar</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">file path in case of ios and base64 image in android</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">default icon color if thumbnail is not present</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_Avatar.js.html">components/Avatar.js</a>, <a href="components_Avatar.js.html#line15">line 15</a>
    </li></ul></dd>
