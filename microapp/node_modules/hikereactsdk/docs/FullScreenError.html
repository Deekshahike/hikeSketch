...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: FullScreenError</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: FullScreenError</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>FullScreenError<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Full Screen error UI component which shows error ui and try again button</div>
...
<article>
    ...
    <h4 class="name" id="FullScreenError"><span class="type-signature"></span>new FullScreenError<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_FullScreenError.js.html">components/FullScreenError.js</a>, <a href="components_FullScreenError.js.html#line13">line 13</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="components_FullScreenError.js.html">components/FullScreenError.js</a>, <a href="components_FullScreenError.js.html#line18">line 18</a>
    </li></ul></dd>
